...
:::expand 클렌징 이력 표 (펼쳐서 보기)
| 진단일 | 고객사/프로젝트 | 레포 | Skill | testbed 삭제 | state 감사 | gitleaks redact | 세션 종료 | 완료 | 로그 위치 |
|:---:|---|---|:---:|:---:|:---:|:---:|:---:|:---:|---|
| (예시) 2026-04-30 | OCB / OCBWEBVIEW | ocb-community-api | injection | ✅ | ✅ | ✅ | ☐ | ☐ | state/ocb-community-api_20260430_1400/llm_data_access_log.json |
| 2026-06-23 | OCB / OCBSUGAR | ocb-gpb | all (injection/xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/ocb-gpb/llm_data_access_log.json |
| 2026-06-17 | OCB / OCBSUGAR | bms_admin | all (injection/xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/bms_admin/llm_data_access_log.json |
| 2026-06-23 | OCB / OCBSUGAR | fail-info | all (injection/xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/fail-info/llm_data_access_log.json |
| 2026-06-03 | OCB / OCBSUGAR | ocb_passbook_enc | all (injection/xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/ocb_passbook_enc/llm_data_access_log.json |
...
| 2026-06-24 | OCB / LIVECM | live-commerce-backend | all (injection/xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/live-commerce-backend/llm_data_access_log.json |
| 2026-06-25 | OCB / LIVECM | live-frontend | all (injection/xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/live-frontend/llm_data_access_log.json |
| 2026-06-25 | OCB / LIVECM | live-frontend-nextjs | all (xss/file/data) | ✅ | ✅ | ✅ | ☐ | ☐ | state/live-frontend-nextjs/llm_data_access_log.json |
